...
public class BidsAndOffersPage extends BasePage {
	//constructor
	public BidsAndOffersPage(AndroidDriver<AndroidElement> aDriver, ExtentTest test){
		 super(aDriver,test);
		}
...
//verfiy tabs in messages page
	public String getTabsInBDPage(String tabName){
				//verfiy tabs
